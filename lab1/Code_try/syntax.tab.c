...
#line 139 "./syntax.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "INT", "$accept", "Exp", YY_NULLPTR
};
#endif
...
#line 16 "./syntax.y" /* yacc.c:1646  */
    { setNode(&(yyval.Node),(yyvsp[0].Node).valInt,"Exp",NULL,&(yyvsp[0].Node),NULL); }
